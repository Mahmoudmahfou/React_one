  ...
  <div id="carouselBasicExample" className="carousel slide carousel-fade" data-mdb-ride="carousel">
    ...
    <div className="carousel-inner">
      ...
      <div className="carousel-item active">
        <img src="Images/pexels-photo-270288.jpeg" className="d-block w-100" alt="Sunset Over the City" />
      ...
      <div className="carousel-item">
        <img src="Images/pexels-photo-4211330.jpeg" className="d-block w-100" alt="Canyon at Nigh" />
        <div className="carousel-caption d-none d-md-block">
      ...
      {/* <!-- Single item --> */}
      <div className="carousel-item">
        <img src="Images/pexels-photo-3675621.jpeg" className="d-block w-100" alt="Cliff Above a Stormy Sea" />
        <div className="carousel-caption d-none d-md-block">
